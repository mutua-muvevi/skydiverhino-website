...
const faqImage = "https://res.cloudinary.com/dqweh6zte/image/upload/v1693092854/Officechest/users/vo6vt18bzi8q2xzdjbqp.jpg";

const Services = ({content, bannerImage, bannerTitle, bannerSubtitle, bannerHeight, contentBackgroundImage }) => {
	return (
		<div>
			<ReusableBanner
				title={bannerTitle? bannerTitle : "Services"}
				subtitle={bannerSubtitle? bannerSubtitle : "The latest news from Skydive Rhino"}
				type="image"
				src={bannerImage}
				height={bannerHeight? bannerHeight : "70vh"}
			/>
			<ContentBlocks backgroundImage={contentBackgroundImage} content={content}/>
			<ServicePricing/>
			<ServiceRequirements/>
			<ServiceFAQ
				faq={faq}
